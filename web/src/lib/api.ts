...
import type {
  ProjectState, ProjectDetail, ProjectEvent, NewProjectInput,
...
export const api = {
  ...
  patchProject: (slug: string, patch: Partial<NewProjectInput & { archived: boolean; manual_position: { x: number; y: number } | null }>) =>
